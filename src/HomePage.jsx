  ...
  return (
    <div>
      ...
      <p className="mt-6 text-2xl leading-relaxed">
        ...
        hopped back onto a plane to backpack southeast Asia with a tour group I
        fell in love with and a boy, who later paid for my flight over to his
        hometown in Australia to explore where the road may have taken us. I had
        been at the company I was working for as a banker for the last
